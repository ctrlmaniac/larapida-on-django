...
def product_files_check(sender, instance, **kwargs):
    # controlla se l'istanza è nuova o no
    try:
        immagine = ProductMedia.objects.get(pk=instance.pk)
